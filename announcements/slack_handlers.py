            ...
            try:
                ...
                client.chat_postMessage(
                    ...
                    blocks=[
                        {
                            "type": "header",
                            "text": {"type": "plain_text", "text": "🔔 Announcement Reminder"}
                        },
                        {
                            "type": "section",
                            "text": {
...
def handle_announcement_submission(ack, body, client, view):
    ...
    try:
        ...
        if template:
            ...
            blocks_json = blocks_json.replace('{title}', title).replace('{content}', content)
...
def handle_confirm_announcement(ack, body, client, action):
    ...
    try:
        ...
        if ReadReceipt.objects.filter(announcement=announcement, user_id=user_id).exists():
    ...
    return [
        ...
        },
        {
            ...
            "element": {
                ...
                "placeholder": {"type": "plain_text", "text": "Enter announcement title"},
                "max_length": 200
            },
        ...
        },
        {
            ...
            "element": {
                ...
                "multiline": True,
                "placeholder": {"type": "plain_text", "text": "Enter announcement content"},
                "max_length": 3000
            },
...
def build_announcement_details_modal(announcement, read_users):
    ...
    return {
        ...
        "blocks": [
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Channel:* #{announcement.channel_name}"}
            },
            {
                "type": "section",
                "text": {
            ...
            {
                "type": "header",
                "text": {"type": "plain_text", "text": f"✓ Confirmed ({len(read_users)})"}
            },
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": read_list}
            }
        ]
    }
